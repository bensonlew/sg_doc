...
// 额外添加的函数， 用于处理contents对象和对图进行基本修改
var showVenn = function(venn_div, contents){
    var colors = [
        "#388E3C", "#F44336", "#0288D1", "#FF9800", "#727272", "#E91E63", "#673AB7",
        "#8BC34A", "#2196F3", "#D32F2F", "#FFC107", "#BDBDBD", "#F8BBD0", "#3F51B5",
        "#CDDC39", "#009688", "#C2185B", "#FFEB3B", "#212121", "#FFCCBC", "#BBDEFB"
    ];
    ...
    var div = d3.select("#" + venn_div).datum(contents.data).call(chart);
    console.log(div);
    div.selectAll(".venn-circle path")
        .filter(function(d) { console.log(d);;legendData.push(d); return d.sets.length == 1; })
    ...
    function annotateSizes() {
        ...
        //     })
        //     .attr("x", function() {
        //         var a = parseInt(d3.select(this.parentNode).attr("x"));
        //         return a;
        //     })
        //     .attr("dy", "0.9em")
