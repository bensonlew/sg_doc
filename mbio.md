...
| 模块名称 | 路径  | 功能说明 |相关应用|
| ------- |-------|-------------|-----|
|[refrna_assemble](http://git.majorbio.com/sanger_bioinfo/SangerBiocluster/tree/master/src/mbio/modules/assemble/refrna_assemble.py) |
[assemble.refrna_assemble] | 无rst 文档|  |
